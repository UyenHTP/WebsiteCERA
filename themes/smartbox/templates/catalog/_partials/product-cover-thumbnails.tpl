  ...
  {block name='product_cover'}
    <div class="product-cover">
      ...
      <div class="product-cover-img">
        <img data-zoom-image="{$product.cover.bySize.large_default.url}" id="zoom_mw"  class="js-qv-product-cover" src="{$product.cover.bySize.medium_default.url}" alt="{$product.cover.legend}" title="{$product.cover.legend}" style="max-width:100%;">
